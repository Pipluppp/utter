	...
	useEffect(() => {
		...
		schedule(() => {
			...
			const intervalMs = Math.max(
				1,
				Math.floor(GENERATE_TIMING[2].duration / totalChars),
			);
			let charIndex = 0;
...
function MockWaveform() {
	...
	const bars = [
		0.15, 0.35, 0.55, 0.8, 0.45, 0.7, 0.9, 0.5, 0.3, 0.65, 0.85, 0.4,
		0.95, 0.6, 0.75, 0.35, 0.5, 0.8, 0.45, 0.7, 0.25, 0.6, 0.9, 0.55,
		0.4, 0.15, 0.1, 0.15, 0.1, 0.15, 0.3, 0.55, 0.75, 0.5, 0.85, 0.65,
		0.4, 0.9, 0.7, 0.55, 0.35, 0.8, 0.6, 0.45, 0.7, 0.5, 0.3, 0.65,
	];
	return (
					...
					<div>
						...
						<div className="relative">
							<div className="w-full border border-border bg-background px-4 py-3 text-sm text-foreground shadow-elevated">
								{selectedVoice || (
									<span className="text-faint">Select a voice...</span>
								)}
							</div>
							<svg
