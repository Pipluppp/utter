  ...
  return (
    <div className="space-y-2">
      {SKELETON_LINE_KEYS.slice(0, lines).map((lineKey, index) => (
        <Skeleton
          key={lineKey}
          className={`h-3 ${widths?.[index] ?? 'w-full max-w-3xl'}`}
        />
      ))}
    </div>
  )
    ...
    <div className="mx-auto w-full max-w-xl py-10" aria-hidden="true">
      <div className="border border-border bg-background p-6 shadow-elevated md:p-8">
        ...
        <div className="mt-3">
          <SkeletonParagraph
            lines={2}
            widths={['w-full max-w-md', 'w-4/5 max-w-sm']}
          />
        </div>
      </div>
    </div>
    ...
    <div className="space-y-10" aria-hidden="true">
      ...
      <div className="border border-border bg-subtle p-5 shadow-elevated">
        ...
        <div className="mt-4">
          <SkeletonParagraph
            lines={4}
            widths={['w-full', 'w-full', 'w-5/6', 'w-2/3']}
          />
        </div>
      </div>
    </div>
    ...
    <div className="space-y-6" aria-hidden="true">
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <SkeletonParagraph
            lines={2}
            widths={['w-full max-w-2xl', 'w-4/5 max-w-xl']}
          />
        </div>
      </div>
      ...
      <div className="flex w-full flex-col justify-between px-6 py-8 sm:px-12 lg:w-1/2 lg:px-20">
        <div className="mx-auto flex w-full max-w-sm flex-1 flex-col justify-center py-12">
          ...
          <div className="mt-3">
            <SkeletonParagraph
              lines={2}
              widths={['w-full max-w-xs', 'w-3/4 max-w-[12rem]']}
            />
          </div>
