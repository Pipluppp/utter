...
export const selectRecipe = tv({
  slots: {
    ...
    popover:
      "w-[var(--trigger-width)] min-w-36 overflow-y-auto rounded-sm border border-border bg-popover shadow-popover data-[placement=bottom]:origin-top data-[placement=top]:origin-bottom entering:animate-in entering:fade-in-0 entering:zoom-in-95 exiting:animate-out exiting:fade-out-0 exiting:zoom-out-95",
