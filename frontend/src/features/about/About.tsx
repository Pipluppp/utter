  ...
  return (
    <div className="space-y-8">
      ...
      <p className="text-sm text-muted-foreground">
        Utter is a Qwen-powered app for voice cloning, voice design, and speech generation.
      </p>
      ...
      <div className="space-y-3 border border-border bg-subtle p-4 shadow-elevated">
        ...
        <ul className="list-disc space-y-2 pl-5 text-sm text-muted-foreground">
          ...
          <li>
            Transcript: voice cloning requires text that matches the reference audio as closely as
            possible.
          </li>
          <li>Generation and design preview run as async jobs and can take longer under load.</li>
          <li>Long text is limited by the current Qwen character cap shown in Generate.</li>
        </ul>
      </div>
