          ...
          <div className="border border-border bg-background p-5 shadow-elevated">
            ...
            <div className="mt-4 space-y-2">
              <Link
                to="/account"
                className={cn(
                  "flex items-center justify-between border border-border px-4 py-3.5 text-[15px] text-foreground press-scale-sm-y data-[hovered]:bg-surface-hover data-[pressed]:bg-surface-hover",
